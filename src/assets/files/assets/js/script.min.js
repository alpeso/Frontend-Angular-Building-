...
$(document).ready(function() {
    $(document).on("click", ".card-header-right .close-card", function() {
        var a = $(this);
        a.parents(".card").animate({ opacity: "0", "-webkit-transform": "scale3d(.3, .3, .3)", transform: "scale3d(.3, .3, .3)" });
        setTimeout(function() { a.parents(".card").remove() }, 800)
    });
    ...
    $(".main-friend-list").slimScroll({ height: b, allowPageScroll: false, wheelStep: 5, color: "#1b8bf9" });
    ...
    $(document).on("click", ".displayChatbox", function() {
        ...
        if (a == "right") { var c = { direction: "left" } } else { var c = { direction: "right" } }
