$.fn.pcodedmenu = function(settings) {
    ...
    var PcodedMenu = {
            ...
            switch (settings.themelayout) {
                case 'horizontal':
                    ...
                    if (trigger === "hover") {
                        ...
                        $(document).on("click", 'li.pcoded-hasmenu', function(e) {
        ...
        HandleOptionSelectorPanel: function() {
            ...
            $(document).on("click", '.selector-toggle > a', function() {
                //debugger;
        ...
        HandleSubMenuTrigger: function() {
            switch (settings.SubMenuTrigger) {
                ...
                case 'click':
                    ...
                    $(document).on("click", '.pcoded-submenu > li', function(e) {
                        e.stopPropagation();
                        var str = $(this).closest('.pcoded-submenu').length;
                        if (str === 0) {
                            if ($(this).hasClass('pcoded-trigger')) {
        ...
        HandleMenuTrigger: function() {
            ...
            switch (settings.MenuTrigger) {
                ...
                case 'click':
                    ...
                    $(document).on("click", '.pcoded-item > li ', function() {
                        if ($(this).hasClass('pcoded-trigger')) {
                            $(this).removeClass('pcoded-trigger');
                            $(this).children('.pcoded-submenu').slideUp();
                        } else {
        ...
        HandleMenuOnClick: function() {
            ...
            if (settings.themelayout === "vertical") {
                $(document).on("click", '#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a', function() {
