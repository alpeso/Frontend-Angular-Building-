...
$(document).ready(function() {
    ...
    function drawChart() {
        ...
        var options = { vAxis: { minValue: 0 }, colors: ['#11c15b', '#ff5252'] };
    ...
    function drawChartStacking() {
        ...
        var options_stacked = { isStacked: true, height: 300, legend: { position: 'top', maxLines: 3 }, vAxis: { minValue: 0 }, colors: ['#11c15b', '#536dfe'] };
    ...
    function drawStacked() {
        ...
        var options = { title: 'Population of Largest U.S. Cities', chartArea: { width: '50%' }, isStacked: true, hAxis: { title: 'Total Population', minValue: 0, }, vAxis: { title: 'City' }, colors: ['#11c15b', '#448aff'] };
    ...
    function drawChartCandlestick() {
        ...
        var optionsCandlestick = { legend: 'none', colors: ['#11c15b'] };
    ...
    function drawChartWaterfall() {
        ...
        var optionsWaterfall = { legend: 'none', bar: { groupWidth: '100%' }, candlestick: { fallingColor: { strokeWidth: 0, fill: '#ff5252' }, risingColor: { strokeWidth: 0, fill: '#11c15b' } } };
    ...
    function drawVisualization() {
        ...
        var options = { title: 'Monthly Coffee Production by Country', vAxis: { title: 'Cups' }, hAxis: { title: 'Month' }, seriesType: 'bars', series: { 5: { type: 'line' } }, colors: ['#448aff', '#11c15b', '#ffe100', '#FE8A7D', '#69CEC6', '#ff5252'] };
    ...
    function drawChartDonut() {
        ...
        var optionsDonut = { title: 'My Daily Activities', pieHole: 0.4, colors: ['#448aff', '#11c15b', '#ffe100', '#FE8A7D', '#ff5252'] };
    ...
    function drawChartExploading() {
        ...
        var optionsExploading = { title: 'Language', legend: 'none', pieSliceText: 'label', slices: { 4: { offset: 0.2 }, 12: { offset: 0.3 }, 14: { offset: 0.4 }, 15: { offset: 0.5 }, }, colors: ['#448aff', '#11c15b', '#ffe100', '#FE8A7D', '#69CEC6', '#ff5252'] };
    ...
    function drawChartThreshold() {
        ...
        var optionsThreshold = { title: 'Popularity of Types of Pizza', sliceVisibilityThreshold: .2, colors: ['#448aff', '#11c15b', '#ff5252', '#ffe100'] };
