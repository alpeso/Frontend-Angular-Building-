! function(e, t, r) {
    ...
    function s(e) {
        e.element;
        return e.id ? "<i class='la la-" + r(e.element).data("icon") + "'></i>" + e.text : e.text
    }
    ...
    var l = r(".js-example-programmatic").select2(),
        c = r(".js-example-programmatic-multi").select2();
    c.select2({
        placeholder: "Programmatic Events"
    }), r(".js-programmatic-set-val").on("click", function() {
        l.val("CA").trigger("change")
    ...
    function o(e) {
        ...
        return e.id ? r('<span><img class="img_icon_bandera" src="https://pcnetwork-production.s3.us-east-2.amazonaws.com/backoffice/pcnetassets/assetUserBackoffice/uploads/flags/' + e.element.id + '" class="img-flag" /> ' + e.text + "</span>") : e.text
    }
    ...
    r(".select2-data-array").select2({
        ...
        var s = "",
            a = "",
            l = r(this).data("bgcolor");
        s = r(this).data("bgcolor-variation"), "" !== (a = r(this).data("text-variation")) && (a = " " + a), "" !== s && (s = " bg-" + s);
        var c = "bg-" + l + s + " " + r(this).data("text-color") + a + " border-" + l + " border-darken-2 ";
        r(this).select2({
            containerCssClass: c
        })
