...
$(document).ready(function() {
    ...
    var u = "overlay";
    var i = "overlay";
    $("#pcoded").pcodedmenu({ themelayout: "vertical", verticalMenuplacement: "left", verticalMenulayout: m, MenuTrigger: "click", SubMenuTrigger: "click", activeMenuClass: "active", ThemeBackgroundPattern: q, HeaderBackground: h, LHeaderBackground: r, NavbarBackground: l, ActiveItemBackground: b, SubItemBackground: "theme2", ActiveItemStyle: "style0", ItemBorder: true, ItemBorderStyle: "none", NavbarImage: B, ActiveNavbarImage: p, freamtype: d, SubItemBorder: true, DropDownIconStyle: "style3", menutype: "st2", layouttype: e, FixedNavbarPosition: true, FixedHeaderPosition: true, collapseVerticalLeftHeader: true, VerticalSubMenuItemIconStyle: "style7", VerticalNavigationView: "view1", verticalMenueffect: { desktop: o, tablet: u, phone: i, }, defaultVerticalMenu: { desktop: "expanded", tablet: "offcanvas", phone: "offcanvas", }, onToggleVerticalMenu: { desktop: "offcanvas", tablet: "expanded", phone: "expanded", }, });

    function c() {

        $(document).on("click", ".theme-color > a.navbg-pattern", function() {
    ...
    function a() {
        ...
        $(document).on("click", ".theme-color > a.Layout-type", function() {
    ...
    function x() {
        $(document).on("click", ".theme-color > a.leftheader-theme", function() {
    ...
    function f() {
        ...
        $(document).on("click", ".theme-color > a.header-theme", function() {
    ...
    function t() {
        ...
        $(document).on("click", ".theme-color > a.navbar-theme", function() {
    ...
    function k() {
        ...
        $(document).on("click", ".theme-color > a.active-item-theme", function() {
    ...
    function y() {
        ...
        $(document).on("click", ".theme-color > a.themebg-pattern", function() {
...
function handlemenutype(a) { $(".pcoded").attr("nav-type", a) }
handlemenutype("st2");