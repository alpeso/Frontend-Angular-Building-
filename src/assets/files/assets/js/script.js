...
$(document).ready(function() {
    $(document).on("click", ".card-header-right .close-card", function() {
        ...
        setTimeout(function() { $this.parents('.card').remove(); }, 800);
    });
    ...
    $(document).on("click", ".card-header-right .card-option .open-card-option", function() {
        ...
        if ($this.hasClass('fa-times')) {
            ...
            $this.parents('.card-option').animate({ 'width': '140px', });
    ...
    $(document).on("click", ".search-close", function() {
        ...
        setTimeout(function() { $(".main-search").removeClass('open'); }, 300);
    });
    ...
    $("#styleSelector .style-cont").slimScroll({ setTop: "1px", height: "calc(100vh - 320px)", });
    $(".main-menu").mCustomScrollbar({ setTop: "1px", setHeight: "calc(100% - 56px)", });
    var a = $(window).height() - 80;
    $(".main-friend-list").slimScroll({ height: a, allowPageScroll: false, wheelStep: 5, color: '#1b8bf9' });
    ...
    $(document).on("click", '.displayChatbox', function() {
        ...
        if (my_val == 'right') { var options = { direction: 'left' }; } else { var options = { direction: 'right' }; }
        $('.showChat').toggle('slide', options, 500);
    });

    $(document).on("click", '.userlist-box', function() {
        var my_val = $('.pcoded').attr('vertical-placement');
        if (my_val == 'right') { var options = { direction: 'left' }; } else { var options = { direction: 'right' }; }
    ...
    $(document).on("click", '.back_friendlist', function() {
        var my_val = $('.pcoded').attr('vertical-placement');
        if (my_val == 'right') { var options = { direction: 'left' }; } else { var options = { direction: 'right' }; }
    ...
    $('.form-control').on('blur', function() { if ($(this).val().length > 0) { $(this).addClass("fill"); } else { $(this).removeClass("fill"); } });
    $('.form-control').on('focus', function() { $(this).addClass("fill"); });
});
$(document).ready(function() {
